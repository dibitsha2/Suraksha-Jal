...
"[project]/src/contexts/language-provider.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const LanguageProvider = ({ children })=>{
    ...
    const [effectiveLanguage, setEffectiveLanguage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('en');
    ...
    const t = (key)=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$translations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["translations"][effectiveLanguage]?.[key] || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$translations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["translations"].en[key] || String(key);
    };
    if (!isMounted) {
        return null;
    }
...
_s(LanguageProvider, "S0Ayd7clK55Y5rrOGW4UxrQihZM=");
_c = LanguageProvider;
var _c;
...
//# sourceMappingURL=src_a65afbcb._.js.map