...
function Sidebar() {
  ...
  const navItems = [
    ...
    { href: '/dashboard-health-worker/submit-report', icon: ClipboardPlus, label: 'Submit Report' },
    { href: '/dashboard-health-worker/medication-stock', icon: Pill, label: 'Medication Stock' },
