...
export default function HealthWorkerDashboardLayout({
  children,
}: {
...
function Sidebar() {
  ...
  const navItems = [
    ...
    { href: '#', icon: Clipboard, label: 'Submit Report' },
    { href: '#', icon: UserCheck, label: 'Patient Follow-up' },
    { href: '#', icon: ShieldCheck, label: 'Guidelines' },
