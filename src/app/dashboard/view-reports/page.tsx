...
import { Globe, MapPin, Search, Calendar, BarChart2, Loader2 } from 'lucide-react';
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <CardTitle className="font-headline text-2xl flex items-center gap-2">
                ...
                <span>Community Health Reports</span>
              </CardTitle>
              <CardDescription>
                View all health reports submitted by health workers and the community.
              </CardDescription>
            </div>
          </div>
        </CardHeader>
